      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-x-4">
            ...
            <Button
              asChild
              className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-full px-6 shadow-lg hover:shadow-xl transition-all duration-300"
            >
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <Link
                      href={`/${locale}/demo`}
                      className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-full font-semibold transition-all hover:scale-105 shadow-lg"
                    >
                      {t('startFree')}
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  ...
                  <div className="-my-6 divide-y divide-gray-500/10">
                    ...
                    <div className="py-6">
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          <Link href={`/${locale}/demo`} onClick={() => setIsMenuOpen(false)}>
                            {t('getDemo')}
                          </Link>
                        </Button>
                      </div>
